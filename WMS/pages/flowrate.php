    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
            <div class="container-fluid">
                <h2 class="mt-3">FlowRate Analysis</h2><br>
                        ...
                        <div class="card mt-3">
                            ...
                            <div class="card-body">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>Select Date Interval </td>
                                        <td>From Date <input type="date"> ToDate <input type="date"></td>
                                    </tr>
                                    <tr>
                                        <td>Maximum FlowRate</td>
                                        <td>: 4500 W. 18th St.</td>
                                    </tr>
                                    <tr>
                                        <td>Minimum FLowRate </td>
                                        <td>: 9990018</td>
                                    </tr>
                                    <tr>
